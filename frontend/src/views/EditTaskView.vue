...
onMounted(async () => {
  try {
    ...
    // Populate inputs
    form.type = state.task.type;
    form.title = state.task.title;
    form.description = state.task.description;
    form.salary = state.task.salary;
    form.location = state.task.location;
    form.company.name = state.task.company.name;
    form.company.description = state.task.company.description;
    form.company.contactEmail = state.task.company.contactEmail;
    form.company.contactPhone = state.task.company.contactPhone;
  } catch (error) {
    console.error("Error fetching task", error);
  } finally {
